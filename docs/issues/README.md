...
| [WB-315](WB-315-server-project-offline-write-authority-drift.md) | ⬜ | P1 | backend | Server 权威项目配置与成员写失败后回退本地，违反统一同步契约 |
...
共 312 条 `fixed` / `wontfix` 记录，按年份和编号段合并保存。详情、处理记录和原始文件名见
