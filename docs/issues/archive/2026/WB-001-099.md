...
<!-- issue-record:start {"id":"WB-001","number":1,"source":"WB-001-zombie-message-on-stop.md","title":"停止/连接失败后助手消息永久卡在「执行中…」","severity":"P0","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-001"></a>
...
<!-- issue-record:start {"id":"WB-002","number":2,"source":"WB-002-blocking-event-loop.md","title":"工具同步执行阻塞事件循环，期间 /stop 失效、全部会话 SSE 卡死","severity":"P0","area":"backend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-002"></a>
...
<!-- issue-record:start {"id":"WB-003","number":3,"source":"WB-003-loadout-leak-into-project.md","title":"ad-hoc loadout（专家/技能/连接器）泄漏进项目执行","severity":"P0","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-003"></a>
...
<!-- issue-record:start {"id":"WB-004","number":4,"source":"WB-004-refpicker-plus-invisible.md","title":"RefPicker「＋」按钮浅色主题下白字白底不可见","severity":"P0","area":"ui","status":"fixed","created":"2026-07-06"} -->
<a id="wb-004"></a>
...
<!-- issue-record:start {"id":"WB-005","number":5,"source":"WB-005-model-overwritten-on-boot.md","title":"启动时用后端默认模型覆盖用户已保存的选择","severity":"P0","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-005"></a>
...
<!-- issue-record:start {"id":"WB-006","number":6,"source":"WB-006-refs-cleared-on-failed-send.md","title":"发送失败/被停止时，一次性 refs 仍被清空","severity":"P1","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-006"></a>
...
<!-- issue-record:start {"id":"WB-007","number":7,"source":"WB-007-chatsearch-stream-jitter.md","title":"ChatSearch 流式抖动 + 当前高亮陈旧","severity":"P1","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-007"></a>
...
<!-- issue-record:start {"id":"WB-008","number":8,"source":"WB-008-dark-mode-gaps.md","title":"暗色主题遗漏（btn-dark:disabled / add-btn / mrow.off）","severity":"P1","area":"ui","status":"fixed","created":"2026-07-06"} -->
<a id="wb-008"></a>
...
<!-- issue-record:start {"id":"WB-009","number":9,"source":"WB-009-sqlite-single-connection.md","title":"全局单 sqlite 连接被线程池 + 事件循环并发共享","severity":"P1","area":"backend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-009"></a>
...
<!-- issue-record:start {"id":"WB-010","number":10,"source":"WB-010-refs-unbounded-payload.md","title":"refs 无数量/总量上限、name 不截断、/chat 无请求体上限","severity":"P1","area":"backend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-010"></a>
...
<!-- issue-record:start {"id":"WB-011","number":11,"source":"WB-011-env-leak-to-connectors.md","title":"连接器子进程继承整个 os.environ（含 LLM_API_KEY）","severity":"P1","area":"backend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-011"></a>
...
<!-- issue-record:start {"id":"WB-012","number":12,"source":"WB-012-session-status-not-reset-on-disconnect.md","title":"客户端断开后会话状态永久停在 running/waiting","severity":"P1","area":"backend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-012"></a>
...
<!-- issue-record:start {"id":"WB-013","number":13,"source":"WB-013-owner-isolation-not-enforced.md","title":"owner_id 隔离未在路由生效（files 可跨项目读）","severity":"P2","area":"backend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-013"></a>
...
<!-- issue-record:start {"id":"WB-014","number":14,"source":"WB-014-run-command-not-sandboxed.md","title":"run_command 非真沙箱（shell=True，仅钉 cwd）","severity":"P2","area":"backend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-014"></a>
...
<!-- issue-record:start {"id":"WB-015","number":15,"source":"WB-015-concurrent-same-session-run.md","title":"同一 session 并发 run 串道（_stop_events/_answers 按 session 共享）","severity":"P2","area":"backend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-015"></a>
...
<!-- issue-record:start {"id":"WB-016","number":16,"source":"WB-016-clickable-div-a11y.md","title":"可点击 <div> 无键盘可达 / 焦点","severity":"P2","area":"ui","status":"fixed","created":"2026-07-06"} -->
<a id="wb-016"></a>
...
<!-- issue-record:start {"id":"WB-017","number":17,"source":"WB-017-upload-reads-full-body.md","title":"上传先把整个请求体读进内存再判大小","severity":"P2","area":"backend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-017"></a>
...
<!-- issue-record:start {"id":"WB-018","number":18,"source":"WB-018-chip-title-truncation.md","title":"长文件名 chip / 长会话标题不截断","severity":"P2","area":"ui","status":"fixed","created":"2026-07-06"} -->
<a id="wb-018"></a>
...
<!-- issue-record:start {"id":"WB-019","number":19,"source":"WB-019-late-events-pollute-session.md","title":"迟到 SSE 事件污染新会话（onEvent 不校验当前流）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-019"></a>
...
<!-- issue-record:start {"id":"WB-020","number":20,"source":"WB-020-sse-last-frame-flush.md","title":"SSE 末帧无空行不冲刷、末尾多字节可能丢失","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-020"></a>
...
<!-- issue-record:start {"id":"WB-021","number":21,"source":"WB-021-navopen-resize-residual.md","title":"navOpen 跨 resize 残留（窄→宽→窄抽屉自开）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-021"></a>
...
<!-- issue-record:start {"id":"WB-022","number":22,"source":"WB-022-context-window-zero-div.md","title":"CONTEXT_WINDOW=0 触发 usage 除零","severity":"P2","area":"backend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-022"></a>
...
<!-- issue-record:start {"id":"WB-023","number":23,"source":"WB-023-low-severity-tail.md","title":"低危备忘集合（13 项）","severity":"P3","area":"misc","status":"fixed","created":"2026-07-06"} -->
<a id="wb-023"></a>
...
<!-- issue-record:start {"id":"WB-024","number":24,"source":"WB-024-sidebar-header-icons-stub.md","title":"侧栏头部三个图标按钮（收起/搜索/筛选）仅弹 toast、未实现","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-024"></a>
...
<!-- issue-record:start {"id":"WB-025","number":25,"source":"WB-025-attach-file-size-limit-too-small.md","title":"＋菜单「添加文件」上限 200KB 过小（且被后端 8000 字符截断掩盖）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-025"></a>
...
<!-- issue-record:start {"id":"WB-026","number":26,"source":"WB-026-plan-todo-detail-and-create-modals.md","title":"计划 · 待办详情弹窗 + 新建待办弹窗 + WorkItem 数据模型扩展","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-026"></a>
...
<!-- issue-record:start {"id":"WB-027","number":27,"source":"WB-027-plan-toolbar-filter-batch-search.md","title":"计划 · 顶部工具条（归属/来源筛选 + 批量操作 + 搜索）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-027"></a>
...
<!-- issue-record:start {"id":"WB-028","number":28,"source":"WB-028-plan-add-datasource-picker-placeholder.md","title":"计划 · 「添加数据源」选择器（占位，明确「敬请期待」，不伪造授权）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-028"></a>
...
<!-- issue-record:start {"id":"WB-029","number":29,"source":"WB-029-plan-add-to-input-as-ref-chip.md","title":"计划 · 「添加到输入框」应作为独立引用 chip 显示，而非混入正文文本","severity":"P2","area":"ui","status":"fixed","created":"2026-07-06"} -->
<a id="wb-029"></a>
...
<!-- issue-record:start {"id":"WB-030","number":30,"source":"WB-030-agent-work-item-status-tools.md","title":"计划 · 计划项作为可执行任务交给 agent，agent 能查看并回写其状态","severity":"P2","area":"backend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-030"></a>
...
<!-- issue-record:start {"id":"WB-031","number":31,"source":"WB-031-live-work-item-sse-sync.md","title":"计划 · agent 改计划项状态时实时回写看板（SSE 事件），而非仅返回时刷新","severity":"P3","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-031"></a>
...
<!-- issue-record:start {"id":"WB-032","number":32,"source":"WB-032-sidebar-task-list-no-scroll.md","title":"侧栏「任务/空间」列表会话多时不滚动，超出部分被挤压/裁掉","severity":"P2","area":"ui","status":"fixed","created":"2026-07-06"} -->
<a id="wb-032"></a>
...
<!-- issue-record:start {"id":"WB-033","number":33,"source":"WB-033-automation-runnow-stuck-running.md","title":"「立即运行」自动化后状态永久卡在「运行中」（前端只刷新一次、无轮询）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-033"></a>
...
<!-- issue-record:start {"id":"WB-034","number":34,"source":"WB-034-automation-view-live-poll.md","title":"自动化看板不反映「到点自动触发」的运行 —— 视图级自适应轮询","severity":"P3","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-034"></a>
...
<!-- issue-record:start {"id":"WB-035","number":35,"source":"WB-035-automation-run-sessions-unreachable.md","title":"自动化产出的会话除「上次运行」外全部不可达（无运行历史入口）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-035"></a>
...
<!-- issue-record:start {"id":"WB-036","number":36,"source":"WB-036-automation-editor-shell-workspace-model.md","title":"自动化编辑器向目标设计对齐（一期）：全屏编辑器骨架 + 工作空间绑定 + 模型选择","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-036"></a>
...
<!-- issue-record:start {"id":"WB-037","number":37,"source":"WB-037-automation-unbind-workspace-silent-noop.md","title":"编辑自动化时「解绑工作空间」静默失败（UI 已清空 + 提示已保存，实际仍绑定）","severity":"P3","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-037"></a>
...
<!-- issue-record:start {"id":"WB-038","number":38,"source":"WB-038-automation-edit-pins-default-model.md","title":"编辑 model=null（跟随默认）的自动化时，保存会把它悄悄钉死到某个模型","severity":"P3","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-038"></a>
...
<!-- issue-record:start {"id":"WB-039","number":39,"source":"WB-039-automation-editor-runs-panel-not-live.md","title":"自动化编辑器右侧「运行历史」侧栏点「立即运行」后不刷新","severity":"P3","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-039"></a>
...
<!-- issue-record:start {"id":"WB-040","number":40,"source":"WB-040-automation-run-now-no-inflight-dedup.md","title":"「立即运行」不与在飞的运行去重，连点/与到点触发并发会重复跑同一自动化","severity":"P3","area":"backend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-040"></a>
...
<!-- issue-record:start {"id":"WB-041","number":41,"source":"WB-041-sidebar-automation-runs-group.md","title":"自动化产出的会话在侧栏不可见——加独立「自动化」分组","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-041"></a>
...
<!-- issue-record:start {"id":"WB-042","number":42,"source":"WB-042-more-menu-detached-position.md","title":"侧栏「更多」弹出菜单位置脱离按钮（固定 bottom:118px，飘到侧栏右下角）","severity":"P2","area":"ui","status":"fixed","created":"2026-07-06"} -->
<a id="wb-042"></a>
...
<!-- issue-record:start {"id":"WB-043","number":43,"source":"WB-043-automation-run-records-tab.md","title":"自动化「运行记录」tab —— 逐次运行状态/摘要持久化 + 跨自动化运行列表 + 详情弹窗","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-043"></a>
...
<!-- issue-record:start {"id":"WB-044","number":44,"source":"WB-044-automation-view-restructure-tabs-list-templates.md","title":"自动化视图重构对齐目标：定时任务/运行记录 tab + 工具条 + 紧凑列表 + 从模版添加独立页","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-044"></a>
...
<!-- issue-record:start {"id":"WB-045","number":45,"source":"WB-045-bound-automation-runs-belong-to-space.md","title":"绑定了工作空间的自动化，其运行会话应归入该「空间」而非「自动化」分组","severity":"P3","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-045"></a>
...
<!-- issue-record:start {"id":"WB-046","number":46,"source":"WB-046-file-endpoints-missing-auth-token.md","title":"登录用户上传/下载文件不带 Bearer token —— uploadFile 原生 fetch 与 downloadUrl 明文 URL 绕过鉴权","severity":"P1","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-046"></a>
...
<!-- issue-record:start {"id":"WB-047","number":47,"source":"WB-047-plan-exec-activity-feed-uninformative-title.md","title":"「动态」tab 中执行计划项的记录只显示随手指令（如「执行它」），看不出执行的是哪个计划项","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-06"} -->
<a id="wb-047"></a>
...
<!-- issue-record:start {"id":"WB-048","number":48,"source":"WB-048-experts-hub-browse-interactions.md","title":"专家/专家团页交互落地（专家团切换 + 分类过滤 + 详情弹窗 + 召唤进会话）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-07"} -->
<a id="wb-048"></a>
...
<!-- issue-record:start {"id":"WB-049","number":49,"source":"WB-049-my-experts-custom-expert-fullstack.md","title":"我的专家 —— 自定义专家全栈（后端持久化 + 人格注入 + 前端创建/列表/召唤）","severity":"P2","area":"backend","status":"fixed","created":"2026-07-07"} -->
<a id="wb-049"></a>
...
<!-- issue-record:start {"id":"WB-050","number":50,"source":"WB-050-chat-foreign-project-access-not-gated.md","title":"非成员可把 /chat 指向他人项目 —— 新建会话分支未校验 project 访问权，run 在该项目沙箱内执行","severity":"P2","area":"backend","status":"fixed","created":"2026-07-07"} -->
<a id="wb-050"></a>
...
<!-- issue-record:start {"id":"WB-051","number":51,"source":"WB-051-telegram-connector.md","title":"新增 Telegram 连接器（内置 MCP server，Bot API 收发消息）","severity":"P2","area":"backend","status":"fixed","created":"2026-07-07"} -->
<a id="wb-051"></a>
...
<!-- issue-record:start {"id":"WB-052","number":52,"source":"WB-052-kdocs-connector-fullstack.md","title":"金山文档连接器全栈落地（后端 kdocs-cli 桥接 MCP + 前端连接器详情弹窗/接入 loadout）","severity":"P2","area":"backend","status":"fixed","created":"2026-07-07"} -->
<a id="wb-052"></a>
...
<!-- issue-record:start {"id":"WB-053","number":53,"source":"WB-053-shared-worktree-commit-discipline.md","title":"共享工作区提交纪律 —— 并发会话下别整文件 git add，按 hunk 暂存","severity":"P3","area":"misc","status":"fixed","created":"2026-07-07"} -->
<a id="wb-053"></a>
...
<!-- issue-record:start {"id":"WB-054","number":54,"source":"WB-054-skillhub-skills-page.md","title":"SkillHub 技能页落地（精选/商店网格+下载星标/分类过滤/安装·关闭·编辑·卸载）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-07"} -->
<a id="wb-054"></a>
...
<!-- issue-record:start {"id":"WB-055","number":55,"source":"WB-055-skillhub-install-backend.md","title":"SkillHub 已安装技能落到后端 + 会话真正挂载（规划）","severity":"P2","area":"backend","status":"fixed","created":"2026-07-07"} -->
<a id="wb-055"></a>
...
<!-- issue-record:start {"id":"WB-056","number":56,"source":"WB-056-skill-detail-view.md","title":"技能详情页（渲染 SKILL.md + 预览/源码 + 去试试/启用/打开文件夹/卸载）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-07"} -->
<a id="wb-056"></a>
...
<!-- issue-record:start {"id":"WB-057","number":57,"source":"WB-057-skill-detail-preview-before-install.md","title":"技能详情应支持\"安装前预览\"（从 SkillHub 拉取，而非仅本地磁盘）","severity":"P2","area":"backend","status":"fixed","created":"2026-07-07"} -->
<a id="wb-057"></a>
...
<!-- issue-record:start {"id":"WB-058","number":58,"source":"WB-058-hub-control-plane-epic.md","title":"AgentMate Hub —— local-first 执行 + 云端控制平面重构（总纲/epic）","severity":"P1","area":"backend","status":"fixed","created":"2026-07-07"} -->
<a id="wb-058"></a>
...
<!-- issue-record:start {"id":"WB-059","number":59,"source":"WB-059-catalog-definitions-to-db.md","title":"目录「真定义」入库 —— 内置专家人格 + 连接器启动注册表 从硬编码迁到 DB","severity":"P2","area":"backend","status":"fixed","created":"2026-07-07"} -->
<a id="wb-059"></a>
...
<!-- issue-record:start {"id":"WB-060","number":60,"source":"WB-060-catalog-showcase-to-db.md","title":"橱窗目录入库 —— catalog.ts 静态商品卡迁到 DB + API，前端改从接口取","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-07"} -->
<a id="wb-060"></a>
...
<!-- issue-record:start {"id":"WB-061","number":61,"source":"WB-061-hub-service-skeleton.md","title":"Hub 服务骨架 —— 独立中心服务：账号/组织/项目/成员/邀请权威源 + 鉴权签发","severity":"P1","area":"backend","status":"fixed","created":"2026-07-07"} -->
<a id="wb-061"></a>
...
<!-- issue-record:start {"id":"WB-062","number":62,"source":"WB-062-local-hub-sync-protocol.md","title":"本地 ⇄ Hub 同步协议 —— 下行拉取(身份/项目/成员/目录) + 上行 outbox 回传(执行产出)","severity":"P1","area":"backend","status":"fixed","created":"2026-07-07"} -->
<a id="wb-062"></a>
...
<!-- issue-record:start {"id":"WB-063","number":63,"source":"WB-063-hub-migration-and-local-fallback.md","title":"迁移与 local-first 回退 —— 存量导入 Hub、目录权威切 Hub 下发、离线/未登录回退","severity":"P2","area":"backend","status":"fixed","created":"2026-07-07"} -->
<a id="wb-063"></a>
...
<!-- issue-record:start {"id":"WB-064","number":64,"source":"WB-064-skillhub-live-catalog.md","title":"SkillHub 浏览列表改为实时（rankings/search），替掉硬编码的静态目录与假下载/星数","severity":"P2","area":"backend","status":"fixed","created":"2026-07-07"} -->
<a id="wb-064"></a>
...
<!-- issue-record:start {"id":"WB-065","number":65,"source":"WB-065-deeper-collab-comments-mentions-presence.md","title":"更深协作 —— 评论 / @提及 / 在线状态（分层：v1 REST+轮询，实时作增强）","severity":"P2","area":"backend","status":"fixed","created":"2026-07-07"} -->
<a id="wb-065"></a>
...
<!-- issue-record:start {"id":"WB-066","number":66,"source":"WB-066-hub-catalog-admin-downlink.md","title":"Hub 目录运营 Admin + 下发覆盖 —— 激活已预埋的 catalog capability","severity":"P2","area":"backend","status":"fixed","created":"2026-07-07"} -->
<a id="wb-066"></a>
...
<!-- issue-record:start {"id":"WB-067","number":67,"source":"WB-067-app-frontend-hub-surface.md","title":"App 前端接 Hub —— 协作面板(评论/在线/通知) + 目录 Admin + 同步/导入入口","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-07"} -->
<a id="wb-067"></a>
...
<!-- issue-record:start {"id":"WB-068","number":68,"source":"WB-068-hub-web-console.md","title":"Hub web 管理控制台 —— Hub 自带的 web UI（账号/项目/成员/邀请/目录 Admin/通知）","severity":"P2","area":"backend","status":"fixed","created":"2026-07-07"} -->
<a id="wb-068"></a>
...
<!-- issue-record:start {"id":"WB-069","number":69,"source":"WB-069-hub-skillhub-catalog-sync.md","title":"Hub 定时镜像 SkillHub 目录（按分类）+ Hub 统一查询代理","severity":"P2","area":"backend","status":"fixed","created":"2026-07-08"} -->
<a id="wb-069"></a>
...
<!-- issue-record:start {"id":"WB-070","number":70,"source":"WB-070-frontend-hub-skillhub-catalog.md","title":"前端接入 Hub SkillHub 镜像目录 + 搜索代理（触发下行 pull + catalogStore 承载 skill 类 + ExpertsView 改读 + 搜索接线）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-08"} -->
<a id="wb-070"></a>
...
<!-- issue-record:start {"id":"WB-071","number":71,"source":"WB-071-local-skill-browse-real-fallback.md","title":"未接 Hub 时技能浏览用真实 rankings 兜底，替掉静态假数据（铁律#1）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-08"} -->
<a id="wb-071"></a>
...
<!-- issue-record:start {"id":"WB-072","number":72,"source":"WB-072-telegram-assistant-channel.md","title":"助理外部渠道（一）—— Telegram 长轮询桥接：收发消息驱动真实 agent","severity":"P2","area":"backend","status":"fixed","created":"2026-07-08"} -->
<a id="wb-072"></a>
...
<!-- issue-record:start {"id":"WB-073","number":73,"source":"WB-073-hub-status-linked-ignores-token.md","title":"/api/hub/status 的 linked 判定忽略当前 Hub token，登录后讨论 UI 不解锁","severity":"P1","area":"backend","status":"fixed","created":"2026-07-08"} -->
<a id="wb-073"></a>
...
<!-- issue-record:start {"id":"WB-074","number":74,"source":"WB-074-presence-never-seen-epoch.md","title":"讨论面板在线状态：从未上线的成员显示「最后活跃 20641 天前」","severity":"P3","area":"frontend","status":"fixed","created":"2026-07-08"} -->
<a id="wb-074"></a>
...
<!-- issue-record:start {"id":"WB-075","number":75,"source":"WB-075-linked-hub-modal-unreachable.md","title":"已连接 Hub 后无入口打开连接弹窗，导入/通知/断开成为不可达死代码","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-08"} -->
<a id="wb-075"></a>
...
<!-- issue-record:start {"id":"WB-076","number":76,"source":"WB-076-global-hub-connect-entry.md","title":"连接 Hub 的入口只藏在项目讨论面板内，无项目的新用户无法首次连接","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-08"} -->
<a id="wb-076"></a>
...
<!-- issue-record:start {"id":"WB-077","number":77,"source":"WB-077-assistant-settings-panel.md","title":"助理设置面板 —— 齿轮点开的真配置（名字/人格/模型/开关/绑定/token 存 DB）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-08"} -->
<a id="wb-077"></a>
...
<!-- issue-record:start {"id":"WB-078","number":78,"source":"WB-078-buddywebmgr-epic.md","title":"BuddyWebMgr —— Hub 控制台升级为完整 Web 管理门户（总纲/epic）","severity":"P1","area":"frontend","status":"fixed","created":"2026-07-08"} -->
<a id="wb-078"></a>
...
<!-- issue-record:start {"id":"WB-079","number":79,"source":"WB-079-buddywebmgr-rename-nav.md","title":"BuddyWebMgr 品牌更名 + 导航重构（门户骨架）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-08"} -->
<a id="wb-079"></a>
...
<!-- issue-record:start {"id":"WB-080","number":80,"source":"WB-080-portal-project-config.md","title":"门户项目管理面 —— 配置编辑（指令 + 连接器/专家/技能 picker）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-08"} -->
<a id="wb-080"></a>
...
<!-- issue-record:start {"id":"WB-081","number":81,"source":"WB-081-hub-work-items-sync.md","title":"团队计划/任务 —— Hub work_items 模型 + 路由 + 本地⇄Hub 同步 + 门户看板","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-08"} -->
<a id="wb-081"></a>
...
<!-- issue-record:start {"id":"WB-082","number":82,"source":"WB-082-catalog-experts-teams-crud.md","title":"目录运营中心框架 + 专家/专家团 类型化 CRUD（替裸 JSON）","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-08"} -->
<a id="wb-082"></a>
...
<!-- issue-record:start {"id":"WB-083","number":83,"source":"WB-083-catalog-connectors-crud.md","title":"目录运营中心 —— 连接器 类型化 CRUD（launch spec 编辑器）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-08"} -->
<a id="wb-083"></a>
...
<!-- issue-record:start {"id":"WB-084","number":84,"source":"WB-084-catalog-skills-skillhub.md","title":"目录运营中心 —— 技能 + SkillHub（浏览/搜索/上架/手动同步）","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-08"} -->
<a id="wb-084"></a>
...
<!-- issue-record:start {"id":"WB-085","number":85,"source":"WB-085-assistant-page-toolbar-real.md","title":"助理页顶栏按钮接真实 transcript —— 对话内搜索 / 分享导出 / 历史提问（去掉 toast 占位）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-08"} -->
<a id="wb-085"></a>
...
<!-- issue-record:start {"id":"WB-086","number":86,"source":"WB-086-multi-assistant-multi-channel-epic.md","title":"多助理 · 多渠道 —— 助理子系统重构（总纲 / epic）","severity":"P1","area":"fullstack","status":"fixed","created":"2026-07-08"} -->
<a id="wb-086"></a>
...
<!-- issue-record:start {"id":"WB-087","number":87,"source":"WB-087-multi-assistant-backend-model.md","title":"多助理 S1 —— 后端数据模型 + CRUD + 多 bot 渠道管理器 + 迁移","severity":"P1","area":"backend","status":"fixed","created":"2026-07-08"} -->
<a id="wb-087"></a>
...
<!-- issue-record:start {"id":"WB-088","number":88,"source":"WB-088-multi-assistant-frontend.md","title":"多助理 S2 —— 前端多助理管理 UI（列表/新建/设置/对话/渠道）","severity":"P1","area":"frontend","status":"fixed","created":"2026-07-08"} -->
<a id="wb-088"></a>
...
<!-- issue-record:start {"id":"WB-089","number":89,"source":"WB-089-multi-assistant-consolidate.md","title":"多助理 S3+S4 收尾 —— 移除兼容层 + 端到端验证 + 关闭 epic","severity":"P1","area":"fullstack","status":"fixed","created":"2026-07-08"} -->
<a id="wb-089"></a>
...
<!-- issue-record:start {"id":"WB-091","number":91,"source":"WB-091-local-hub-work-items-sync.md","title":"本地 App ⇄ Hub work_items 双向同步（WB-081 的二期）","severity":"P3","area":"backend","status":"fixed","created":"2026-07-08"} -->
<a id="wb-091"></a>
...
<!-- issue-record:start {"id":"WB-092","number":92,"source":"WB-092-skillhub-tab-parity.md","title":"BuddyWebMgr SkillHub 页向真实 SkillHub 站点对齐（发布来源/排序/富卡片）","severity":"P3","area":"frontend","status":"fixed","created":"2026-07-08"} -->
<a id="wb-092"></a>
...
<!-- issue-record:start {"id":"WB-093","number":93,"source":"WB-093-assistant-token-visible-env-cleanup.md","title":"助理渠道 token 本机可见（撤销 write-only）+ 移除 .env Telegram 配置 + 铁律#4 同步","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-08"} -->
<a id="wb-093"></a>
...
<!-- issue-record:start {"id":"WB-094","number":94,"source":"WB-094-skillhub-cli-to-http.md","title":"SkillHub 取数从 CLI 子进程改为直连 HTTP（去 CLI 依赖 + 拿到发布时间）","severity":"P3","area":"backend","status":"fixed","created":"2026-07-08"} -->
<a id="wb-094"></a>
...
<!-- issue-record:start {"id":"WB-095","number":95,"source":"WB-095-skillhub-api-key-setting.md","title":"BuddyWebMgr 设置页 —— 保存 SkillHub API key（Hub 服务端存储 + 注入取数）","severity":"P3","area":"fullstack","status":"fixed","created":"2026-07-08"} -->
<a id="wb-095"></a>
...
<!-- issue-record:start {"id":"WB-096","number":96,"source":"WB-096-email-channel.md","title":"助理邮件渠道 —— IMAP 收 + SMTP 发（多渠道新类型，接入多助理）","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-08"} -->
<a id="wb-096"></a>
...
<!-- issue-record:start {"id":"WB-097","number":97,"source":"WB-097-channel-typemenu-clipped.md","title":"助理「新增渠道」类型菜单被滚动容器裁切（顶部项看不见）","severity":"P2","area":"ui","status":"fixed","created":"2026-07-09"} -->
<a id="wb-097"></a>
...
<!-- issue-record:start {"id":"WB-098","number":98,"source":"WB-098-email-self-reply-loop.md","title":"邮件渠道自我回复循环 —— 助手回信落回收件箱被当新邮件反复处理","severity":"P1","area":"backend","status":"fixed","created":"2026-07-09"} -->
<a id="wb-098"></a>
...
<!-- issue-record:start {"id":"WB-099","number":99,"source":"WB-099-console-grid-overflow.md","title":"BuddyWebMgr SkillHub 页横向溢出（CSS grid 1fr 被内容撑破）","severity":"P3","area":"ui","status":"fixed","created":"2026-07-09"} -->
<a id="wb-099"></a>
