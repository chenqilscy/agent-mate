...
<!-- issue-record:start {"id":"WB-100","number":100,"source":"WB-100-console-experts-showroom.md","title":"BuddyWebMgr 专家/专家团升级为 App 同款浏览橱窗（替裸 CRUD）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-09"} -->
<a id="wb-100"></a>
...
<!-- issue-record:start {"id":"WB-101","number":101,"source":"WB-101-console-connector-gallery.md","title":"BuddyWebMgr 连接器目录只有 CRUD 管理，缺主应用那样的「浏览橱窗」","severity":"P3","area":"ui","status":"fixed","created":"2026-07-09"} -->
<a id="wb-101"></a>
...
<!-- issue-record:start {"id":"WB-102","number":102,"source":"WB-102-console-skill-gallery.md","title":"BuddyWebMgr 技能目录只有 CRUD 管理，缺主应用那样的「浏览橱窗」（整页技能）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-09"} -->
<a id="wb-102"></a>
...
<!-- issue-record:start {"id":"WB-103","number":103,"source":"WB-103-professional-pm-epic.md","title":"BuddyWebMgr 专业项目管理 + App 数据打通（总纲 / epic）","severity":"P1","area":"fullstack","status":"fixed","created":"2026-07-09"} -->
<a id="wb-103"></a>
...
<!-- issue-record:start {"id":"WB-104","number":104,"source":"WB-104-hub-pm-data-model.md","title":"Hub 专业 PM 数据模型 + 迁移（work_items 新字段 + milestones + activity）","severity":"P1","area":"backend","status":"fixed","created":"2026-07-09"} -->
<a id="wb-104"></a>
...
<!-- issue-record:start {"id":"WB-105","number":105,"source":"WB-105-hub-pm-api.md","title":"Hub 专业 PM API（work_items 全字段 + 子任务 + milestones CRUD + 活动 feed）","severity":"P1","area":"backend","status":"fixed","created":"2026-07-09"} -->
<a id="wb-105"></a>
...
<!-- issue-record:start {"id":"WB-106","number":106,"source":"WB-106-portal-task-professional.md","title":"BuddyWebMgr 门户任务专业化 —— 看板卡片富信息 + 任务详情抽屉 + 里程碑 + 子任务 + 活动流","severity":"P1","area":"frontend","status":"fixed","created":"2026-07-09"} -->
<a id="wb-106"></a>
...
<!-- issue-record:start {"id":"WB-107","number":107,"source":"WB-107-portal-task-views-filters.md","title":"BuddyWebMgr 门户任务 —— 列表视图 + 甘特/时间线视图 + 筛选/排序","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-09"} -->
<a id="wb-107"></a>
...
<!-- issue-record:start {"id":"WB-108","number":108,"source":"WB-108-app-hub-pm-integration.md","title":"App↔Hub 专业 PM 打通（同步扩展 + 本地模型对齐 + App 工作台任务 UI）","severity":"P1","area":"fullstack","status":"fixed","created":"2026-07-09"} -->
<a id="wb-108"></a>
...
<!-- issue-record:start {"id":"WB-109","number":109,"source":"WB-109-app-featured-consume-hub.md","title":"App 精选技能区消费 Hub 的 SKILLHUB_FEATURED（打通 mgr「加入精选」→ App，渲染真图标）","severity":"P3","area":"frontend","status":"fixed","created":"2026-07-09"} -->
<a id="wb-109"></a>
...
<!-- issue-record:start {"id":"WB-110","number":110,"source":"WB-110-portal-kanban-drag-activity.md","title":"BuddyWebMgr 门户 PM 增强 —— 看板拖拽换列 + 项目级任务活动流面板","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-09"} -->
<a id="wb-110"></a>
...
<!-- issue-record:start {"id":"WB-111","number":111,"source":"WB-111-portal-pm-workspace-redesign.md","title":"BuddyWebMgr 门户项目管理专业化重构 —— 项目详情标签页工作台（概览/任务/协作/配置）+ Linear 风看板/列表/甘特","severity":"P1","area":"frontend","status":"fixed","created":"2026-07-10"} -->
<a id="wb-111"></a>
...
<!-- issue-record:start {"id":"WB-112","number":112,"source":"WB-112-manager-positioning-data-spec.md","title":"AgentMate Manager 管理端定位 —— 改名 + 数据分层规范 + 统一用户 + 协作打通 + PM 细化（epic）","severity":"P1","area":"fullstack","status":"fixed","created":"2026-07-10"} -->
<a id="wb-112"></a>
...
<!-- issue-record:start {"id":"WB-113","number":113,"source":"WB-113-pm-board-view-enhancements.md","title":"PM 细化之一 —— 看板/视图增强（泳道分组 + WIP 上限 + 保存的视图 + 批量操作）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-10"} -->
<a id="wb-113"></a>
...
<!-- issue-record:start {"id":"WB-114","number":114,"source":"WB-114-pm-task-templates-inline-edit.md","title":"PM 细化之二（纯前端片）—— 任务模板 + 列表内联编辑 + 子任务进度条","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-10"} -->
<a id="wb-114"></a>
...
<!-- issue-record:start {"id":"WB-115","number":115,"source":"WB-115-pm-workload-task-comments.md","title":"PM 细化之三 协作联动 —— 按负责人工作量视图（前端）+ 任务级评论（Hub 后端 + 控制台）","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-10"} -->
<a id="wb-115"></a>
...
<!-- issue-record:start {"id":"WB-116","number":116,"source":"WB-116-pm-effort-hours.md","title":"PM 细化之四 计划与度量（片1）—— 工时预估与投入（Manager 侧）","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-10"} -->
<a id="wb-116"></a>
...
<!-- issue-record:start {"id":"WB-117","number":117,"source":"WB-117-app-pm-alignment.md","title":"App 端项目管理对齐 Manager（epic）—— 片1：工时字段全链路打通","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-10"} -->
<a id="wb-117"></a>
...
<!-- issue-record:start {"id":"WB-118","number":118,"source":"WB-118-app-task-comments.md","title":"App 端 PM 对齐 Manager 片2 —— 任务级评论（App 后端代理 + 任务详情评论区）","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-10"} -->
<a id="wb-118"></a>
...
<!-- issue-record:start {"id":"WB-119","number":119,"source":"WB-119-app-workload-view.md","title":"App 端 PM 对齐 Manager 片3 —— 工作量视图（按负责人负载 tab）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-10"} -->
<a id="wb-119"></a>
...
<!-- issue-record:start {"id":"WB-120","number":120,"source":"WB-120-app-tasklist-inline.md","title":"App 端 PM 对齐 Manager 片4 —— 任务列表增强（内联编辑状态/优先级 + 负责人头像）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-10"} -->
<a id="wb-120"></a>
...
<!-- issue-record:start {"id":"WB-121","number":121,"source":"WB-121-app-gantt-view.md","title":"App 端 PM 对齐 Manager 片5 —— 甘特视图（时间线 tab）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-10"} -->
<a id="wb-121"></a>
...
<!-- issue-record:start {"id":"WB-122","number":122,"source":"WB-122-app-task-templates.md","title":"App 端 PM 对齐 Manager 片6 —— 任务模板（存为模板 + 从模板新建）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-10"} -->
<a id="wb-122"></a>
...
<!-- issue-record:start {"id":"WB-123","number":123,"source":"WB-123-app-kanban-enhancements.md","title":"App 端 PM 对齐 Manager 片7 —— 看板增强（WIP 上限 + 泳道分组 + 保存视图）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-10"} -->
<a id="wb-123"></a>
...
<!-- issue-record:start {"id":"WB-124","number":124,"source":"WB-124-model-management-custom-models.md","title":"模型管理 —— 自定义模型全栈（多厂商 base/key、DB 按用户隔离、内置项可隐藏、切换真生效）","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-12"} -->
<a id="wb-124"></a>
...
<!-- issue-record:start {"id":"WB-125","number":125,"source":"WB-125-merge-skillhub-into-skills-tab.md","title":"目录运营中心「SkillHub」顶层 tab 与「技能」tab 冗余，SkillHub 并入技能作第三子视图","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-12"} -->
<a id="wb-125"></a>
...
<!-- issue-record:start {"id":"WB-126","number":126,"source":"WB-126-skillhub-sync-http-leftover.md","title":"SkillHub 同步 HTTP 化后的收尾 —— 前端文案仍写「跑 CLI」+ 后台定期同步被 cli_available 卡住","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-12"} -->
<a id="wb-126"></a>
...
<!-- issue-record:start {"id":"WB-127","number":127,"source":"WB-127-skillhub-sync-list-no-detail.md","title":"目录运营中心「SkillHub 同步」列表无查看技能详情入口","severity":"P3","area":"frontend","status":"fixed","created":"2026-07-12"} -->
<a id="wb-127"></a>
...
<!-- issue-record:start {"id":"WB-128","number":128,"source":"WB-128-builtin-provider-channels.md","title":"模型管理重构 —— 内置改「厂商渠道」（真实 base/模型，填 key 即用）+ 移除假 Auto，自定义作兜底","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-12"} -->
<a id="wb-128"></a>
...
<!-- issue-record:start {"id":"WB-129","number":129,"source":"WB-129-provider-editable-base-live-models.md","title":"厂商渠道 base_url/请求路径可显示可编辑 + 在线拉取真实模型列表（治「预置值不准/模型名过时」）","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-12"} -->
<a id="wb-129"></a>
...
<!-- issue-record:start {"id":"WB-130","number":130,"source":"WB-130-console-skill-detail-files.md","title":"目录运营中心技能详情缺「文件信息」（SKILL.md 正文/文件树/源码）—— Hub 加单技能拉包代理 + 弹窗渲染","severity":"P3","area":"fullstack","status":"fixed","created":"2026-07-12"} -->
<a id="wb-130"></a>
...
<!-- issue-record:start {"id":"WB-131","number":131,"source":"WB-131-manager-nav-ia-redesign.md","title":"AgentMate Manager 导航/IA 专业化重构（分区侧栏 + 顶栏 + 概览页 + 收编黑话）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-12"} -->
<a id="wb-131"></a>
...
<!-- issue-record:start {"id":"WB-132","number":132,"source":"WB-132-model-capabilities-cost-meta.md","title":"模型能力/成本元数据管理（为 Auto 模式铺路）+ 接入地址简化为仅 Base URL","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-12"} -->
<a id="wb-132"></a>
...
<!-- issue-record:start {"id":"WB-133","number":133,"source":"WB-133-drop-hide-restore-unify-delete.md","title":"去掉厂商模型「隐藏/恢复」机制，统一为「删除」","severity":"P3","area":"frontend","status":"fixed","created":"2026-07-13"} -->
<a id="wb-133"></a>
...
<!-- issue-record:start {"id":"WB-134","number":134,"source":"WB-134-curated-model-defaults-tiered-pricing.md","title":"内置厂商按官方文档建准确「能力+定价」默认表 + 定价 schema 扩展（缓存命中价/币种）+ 更新过时 seed 模型名","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-13"} -->
<a id="wb-134"></a>
...
<!-- issue-record:start {"id":"WB-135","number":135,"source":"WB-135-glm-official-pricing.md","title":"补齐智谱 GLM 官方定价（文本+视觉，人民币/分档）+ seed 对齐现役旗舰 + 视觉模型补 image/video 能力","severity":"P2","area":"backend","status":"fixed","created":"2026-07-13"} -->
<a id="wb-135"></a>
...
<!-- issue-record:start {"id":"WB-136","number":136,"source":"WB-136-ui-default-model-not-env.md","title":"「默认模型」改为在「配置模型」里选择，不再从 .env 读取","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-14"} -->
<a id="wb-136"></a>
...
<!-- issue-record:start {"id":"WB-137","number":137,"source":"WB-137-home-ctray-stub-buttons.md","title":"首页「选择工作空间 / 默认权限」两个 tray 按钮是 toast 桩，未真正实现","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-137"></a>
...
<!-- issue-record:start {"id":"WB-138","number":138,"source":"WB-138-model-mgmt-to-left-menu.md","title":"模型管理入口从输入框「配置模型」改到左侧「更多」菜单","severity":"P2","area":"frontend","status":"fixed","created":""} -->
<a id="wb-138"></a>
...
<!-- issue-record:start {"id":"WB-139","number":139,"source":"WB-139-local-voice-input-asr.md","title":"语音输入落地 —— 本地 ASR 小模型（faster-whisper），按住说话松开转写","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-14"} -->
<a id="wb-139"></a>
...
<!-- issue-record:start {"id":"WB-140","number":140,"source":"WB-140-kdocs-sidebar-panel.md","title":"侧栏「金山文档」面板真接入 —— 最近/搜索云文档，点开跳转，连接态引导","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-14"} -->
<a id="wb-140"></a>
...
<!-- issue-record:start {"id":"WB-141","number":141,"source":"WB-141-glm-knowledge-base-rag-epic.md","title":"GLM 知识库 RAG 接入（总纲/epic）—— 本地 backend 执行 + Manager 目录管理","severity":"P1","area":"fullstack","status":"fixed","created":"2026-07-14"} -->
<a id="wb-141"></a>
...
<!-- issue-record:start {"id":"WB-142","number":142,"source":"WB-142-glm-kb-backend-engine.md","title":"GLM 知识库 Phase A —— 本地 backend 真·知识库引擎 + 路由","severity":"P1","area":"backend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-142"></a>
...
<!-- issue-record:start {"id":"WB-143","number":143,"source":"WB-143-glm-kb-agent-retrieve-tool.md","title":"GLM 知识库 Phase B —— knowledge_retrieve 工具接进 agent 工具循环 + loadout","severity":"P1","area":"backend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-143"></a>
...
<!-- issue-record:start {"id":"WB-144","number":144,"source":"WB-144-glm-kb-app-frontend.md","title":"GLM 知识库 Phase C —— App 前端知识库管理 + loadout 选择器","severity":"P1","area":"frontend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-144"></a>
...
<!-- issue-record:start {"id":"WB-145","number":145,"source":"WB-145-glm-kb-manager-console.md","title":"GLM 知识库 Phase D —— Manager console 知识库橱窗 + 目录管理","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-145"></a>
...
<!-- issue-record:start {"id":"WB-146","number":146,"source":"WB-146-settings-center-shell.md","title":"统一「设置中心」弹窗 —— 双栏外壳 + 迁移已有标签（模型/助理设置/外观·个性化），其余标签诚实占位","severity":"P1","area":"frontend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-146"></a>
...
<!-- issue-record:start {"id":"WB-147","number":147,"source":"WB-147-personalization-backend.md","title":"个性化真后端 —— 回复风格预设 + 自定义指令（按 owner 存 KV，注入 agent 系统提示真生效）","severity":"P1","area":"fullstack","status":"fixed","created":"2026-07-14"} -->
<a id="wb-147"></a>
...
<!-- issue-record:start {"id":"WB-148","number":148,"source":"WB-148-memory-backend.md","title":"记忆真后端 —— 对话记忆持久化 + 注入 agent（真生效）+ 开启后从对话自动抽取 + 前端记忆 tab","severity":"P1","area":"fullstack","status":"fixed","created":"2026-07-14"} -->
<a id="wb-148"></a>
...
<!-- issue-record:start {"id":"WB-149","number":149,"source":"WB-149-data-management-backend.md","title":"数据管理真后端 —— 数据导出（真 dump 用户数据）+ 清空个人对话记录（真删除·二次确认）","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-14"} -->
<a id="wb-149"></a>
...
<!-- issue-record:start {"id":"WB-150","number":150,"source":"WB-150-agent-settings-backend.md","title":"智能体设置真后端 —— 工具步数上限 + 回复发散度(temperature)，按 owner 存 KV 且 run_chat 真读真用","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-14"} -->
<a id="wb-150"></a>
...
<!-- issue-record:start {"id":"WB-151","number":151,"source":"WB-151-glm-kb-review-fixes.md","title":"GLM 知识库 WB-141 审查修复 —— 轮询闭包/无扩展名/key 前置/空 body/形状守卫","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-14"} -->
<a id="wb-151"></a>
...
<!-- issue-record:start {"id":"WB-152","number":152,"source":"WB-152-security-center-backend.md","title":"安全中心真后端 —— 命令安全策略(黑名单·真拦截) + 审计日志(真记录 run_command/网络访问)","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-14"} -->
<a id="wb-152"></a>
...
<!-- issue-record:start {"id":"WB-153","number":153,"source":"WB-153-shared-backend-project-access-control.md","title":"共享后端多用户隔离漏洞 —— 会话可绑他人项目、Viewer 可执行/写、/stop·/answer 无 owner 校验","severity":"P0","area":"backend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-153"></a>
...
<!-- issue-record:start {"id":"WB-154","number":154,"source":"WB-154-inproc-connector-sandbox-leak.md","title":"内置连接器经 os.environ 传 workspace 目录 —— 并发 run 串项目沙箱","severity":"P1","area":"backend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-154"></a>
...
<!-- issue-record:start {"id":"WB-155","number":155,"source":"WB-155-assistant-shared-session-cross-user-reply.md","title":"助理多渠道共享 session —— 并发 run 交错 + before 快照把他人回复当自己的返回（跨用户串信）","severity":"P1","area":"backend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-155"></a>
...
<!-- issue-record:start {"id":"WB-156","number":156,"source":"WB-156-hub-invite-reuse-and-viewer-writes.md","title":"Hub 访问控制 —— 邀请码可无限重用/永不失效 + Viewer 越权（timeline 上报 / org 建项目）","severity":"P1","area":"backend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-156"></a>
...
<!-- issue-record:start {"id":"WB-157","number":157,"source":"WB-157-hub-pm-referential-integrity.md","title":"Hub PM 引用完整性 —— parent_id/milestone_id 跨项目未校验 + 级联删除/清空无 project 过滤","severity":"P2","area":"backend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-157"></a>
...
<!-- issue-record:start {"id":"WB-158","number":158,"source":"WB-158-hub-origin-offline-write-data-loss.md","title":"hub-origin 项目离线新建 work_item/milestone 被下次镜像删除（数据丢失）","severity":"P2","area":"backend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-158"></a>
...
<!-- issue-record:start {"id":"WB-159","number":159,"source":"WB-159-frontend-store-robustness.md","title":"前端 store 健壮性 —— 看板乐观更新不回滚、answer 失败丢问题卡挂起 agent、send finally 无流守卫、connect 不 reload","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-159"></a>
...
<!-- issue-record:start {"id":"WB-160","number":160,"source":"WB-160-backend-hardening-tail.md","title":"后端加固尾集 —— 通知空 ids 误清全部 / MCP 连接超时孤儿子进程 / 邮件批量先标已读丢信 / 流出错丢半截回复 / web_fetch SSRF / skillhub slug 校验","severity":"P2","area":"backend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-160"></a>
...
<!-- issue-record:start {"id":"WB-161","number":161,"source":"WB-161-authoritative-docs-correction.md","title":"权威现状文档纠偏 —— CLAUDE.md/README/实现方案 对「Hub 已建成 / auth 已真 / LLM key 入库 / CSS 非 Modules / Tauri 已接」的错误陈述","severity":"P2","area":"misc","status":"fixed","created":"2026-07-14"} -->
<a id="wb-161"></a>
...
<!-- issue-record:start {"id":"WB-162","number":162,"source":"WB-162-memory-mechanism-optimization.md","title":"记忆机制优化 —— 注入预算化 + 结构化抽取(合并/更替) + 抽取输入预算 + 手动编辑","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-14"} -->
<a id="wb-162"></a>
...
<!-- issue-record:start {"id":"WB-163","number":163,"source":"WB-163-manager-user-management.md","title":"Manager 用户管理功能 —— 平台账号 admin CRUD（列表/建/改/重置密码/删）","severity":"P1","area":"backend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-163"></a>
...
<!-- issue-record:start {"id":"WB-164","number":164,"source":"WB-164-app-login-via-manager.md","title":"App 登录经 Manager 验证 + 两端用户数据打通（Manager 权威 + 离线兜底）","severity":"P1","area":"backend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-164"></a>
...
<!-- issue-record:start {"id":"WB-165","number":165,"source":"WB-165-cognitive-memory-epic.md","title":"认知记忆机制移植（参考 AgentOS）—— 强度/衰减/使用强化 + 本地语义检索 + 白盒管理（epic）","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-14"} -->
<a id="wb-165"></a>
...
<!-- issue-record:start {"id":"WB-166","number":166,"source":"WB-166-memory-strength-decay-lifecycle.md","title":"认知记忆 档一 —— 强度/衰减/使用强化 + 软状态生命周期（无嵌入）","severity":"P2","area":"backend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-166"></a>
...
<!-- issue-record:start {"id":"WB-167","number":167,"source":"WB-167-memory-local-semantic-retrieval.md","title":"认知记忆 档二 —— 本地嵌入 + 语义去重/自动更替 + 相关性检索注入","severity":"P2","area":"backend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-167"></a>
...
<!-- issue-record:start {"id":"WB-168","number":168,"source":"WB-168-memory-whitebox-management-ui.md","title":"认知记忆 档三 —— 白盒管理（API 扩展 + 设置·记忆面板升级）","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-14"} -->
<a id="wb-168"></a>
...
<!-- issue-record:start {"id":"WB-169","number":169,"source":"WB-169-console-kb-tpl-dim-slice-dropdowns.md","title":"Manager 知识库模板编辑器 —— 新增「向量维度」联动下拉 + 切片方式改下拉 + 切片字数条件显示","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-169"></a>
...
<!-- issue-record:start {"id":"WB-170","number":170,"source":"WB-170-memory-embedding-backend-configurable.md","title":"记忆嵌入后端可配置 —— 本地(fastembed) ⇄ 在线(GLM embedding-3) 用户可选","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-14"} -->
<a id="wb-170"></a>
...
<!-- issue-record:start {"id":"WB-171","number":171,"source":"WB-171-hub-knowledge-base-document-backend.md","title":"Hub 真·知识库 + 文档后端（项目级）—— 建库/传档/维度锁，Manager 不算向量","severity":"P2","area":"backend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-171"></a>
...
<!-- issue-record:start {"id":"WB-172","number":172,"source":"WB-172-manager-project-knowledge-base-tab.md","title":"Manager 项目「知识库」tab —— 真·建库(向量维度/切片方式下拉)+文档上传/列/删+维度锁","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-172"></a>
...
<!-- issue-record:start {"id":"WB-173","number":173,"source":"WB-173-knowledge-base-via-weknora-backend.md","title":"知识库改用自托管 WeKnora（后端 + 部署）—— 后端当 WeKnora 客户端，替换 GLM 托管 KB","severity":"P2","area":"backend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-173"></a>
...
<!-- issue-record:start {"id":"WB-174","number":174,"source":"WB-174-knowledge-base-weknora-frontend.md","title":"知识库前端去 GLM 旋钮 —— 配 WeKnora 后端（KnowledgeView/api/types）","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-14"} -->
<a id="wb-174"></a>
...
<!-- issue-record:start {"id":"WB-175","number":175,"source":"WB-175-agent-knowledge-add-tool.md","title":"会话内 agent 无法「把文件加入知识库」—— 补 knowledge_add 工具（工作区文件 → 挂载的 WeKnora 库）","severity":"P2","area":"backend","status":"fixed","created":"2026-07-16"} -->
<a id="wb-175"></a>
...
<!-- issue-record:start {"id":"WB-176","number":176,"source":"WB-176-trim-experts-showcase-data.md","title":"精简专家/专家团橱窗数据 —— 三层数据源同步裁剪，只留常用少量","severity":"P3","area":"fullstack","status":"fixed","created":"2026-07-16"} -->
<a id="wb-176"></a>
...
<!-- issue-record:start {"id":"WB-177","number":177,"source":"WB-177-connectors-showcase-weknora.md","title":"连接器橱窗改版 —— 去掉 5 个连接器、新增 WeKnora 知识库连接器","severity":"P3","area":"fullstack","status":"fixed","created":"2026-07-16"} -->
<a id="wb-177"></a>
...
<!-- issue-record:start {"id":"WB-178","number":178,"source":"WB-178-skills-subsystem-epic.md","title":"技能子系统重构 —— 以 slug 为主键焊死「橱窗/loadout/磁盘」三层（总纲/epic）","severity":"P1","area":"fullstack","status":"fixed","created":"2026-07-16"} -->
<a id="wb-178"></a>
...
<!-- issue-record:start {"id":"WB-179","number":179,"source":"WB-179-skill-identity-and-fallback-prompt.md","title":"技能身份断裂 —— loadout 存展示名 + skill_def 兜底话术伪装能力（铁律#1）","severity":"P1","area":"fullstack","status":"fixed","created":"2026-07-16"} -->
<a id="wb-179"></a>
...
<!-- issue-record:start {"id":"WB-180","number":180,"source":"WB-180-skill-picker-ignores-installed.md","title":"＋菜单技能选择器只读静态 SK_GRID —— 真实已安装的技能在会话里选不到","severity":"P1","area":"frontend","status":"fixed","created":"2026-07-16"} -->
<a id="wb-180"></a>
...
<!-- issue-record:start {"id":"WB-181","number":181,"source":"WB-181-skills-page-fake-interactions.md","title":"技能页假交互清理 —— 推荐段＋号/安装套件/排序/＋添加技能 全是 toast 桩（铁律#1）","severity":"P1","area":"frontend","status":"fixed","created":"2026-07-16"} -->
<a id="wb-181"></a>
...
<!-- issue-record:start {"id":"WB-182","number":182,"source":"WB-182-skill-kits-fabricated.md","title":"「套件」100% 虚构 —— 前端 4 条静态卡、后端零代码、Hub 无源、DB 无表","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-16"} -->
<a id="wb-182"></a>
...
<!-- issue-record:start {"id":"WB-183","number":183,"source":"WB-183-catalog-skills-to-db.md","title":"技能目录/定义未入库 —— WB-059 漏项：专家人格与连接器进了 DB，技能仍硬编码在 skills.py","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-16"} -->
<a id="wb-183"></a>
...
<!-- issue-record:start {"id":"WB-184","number":184,"source":"WB-184-skill-browse-sources-convergence.md","title":"技能浏览面板四套数据源 + 两套分类体系并存 —— 收敛为一个面板一套分类","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-16"} -->
<a id="wb-184"></a>
...
<!-- issue-record:start {"id":"WB-185","number":185,"source":"WB-185-skills-api-attack-surface.md","title":"/api/skills 攻击面 —— App 侧 install/preview 的 slug 未校验（WB-160 只修了 Hub 孪生站点）+ 九端点零鉴权","severity":"P2","area":"backend","status":"fixed","created":"2026-07-16"} -->
<a id="wb-185"></a>
...
<!-- issue-record:start {"id":"WB-186","number":186,"source":"WB-186-skills-backend-consistency-tail.md","title":"技能后端一致性尾集 —— plan 模式不约束技能工具 / rankings 绕过 Manager 违反 WB-130 / 预览缓存无 TTL / schema 不去重","severity":"P3","area":"backend","status":"fixed","created":"2026-07-16"} -->
<a id="wb-186"></a>
...
<!-- issue-record:start {"id":"WB-187","number":187,"source":"WB-187-resolve-slug-installs-wrong-skill.md","title":"按名安装取搜索首条 —— 名字不存在时静默装上无关技能，且被改名伪装成用户要的那个","severity":"P2","area":"backend","status":"fixed","created":"2026-07-16"} -->
<a id="wb-187"></a>
...
<!-- issue-record:start {"id":"WB-188","number":188,"source":"WB-188-weknora-config-form.md","title":"WeKnora 连接配置改为 UI 表单提交（按 owner 入库，不再只能改 .env）","severity":"P2","area":"fullstack","status":"fixed","created":"2026-07-16"} -->
<a id="wb-188"></a>
...
<!-- issue-record:start {"id":"WB-189","number":189,"source":"WB-189-project-connectors-picker-cleanup.md","title":"新建项目的连接器选择器/模板仍留着已下架的连接器（乐享知识库/腾讯文档/TAPD）","severity":"P3","area":"fullstack","status":"fixed","created":"2026-07-16"} -->
<a id="wb-189"></a>
...
<!-- issue-record:start {"id":"WB-190","number":190,"source":"WB-190-skills-tencent-docs-cleanup.md","title":"技能侧仍留着「腾讯文档」条目（橱窗/推荐/SkillHub 商店），与连接器侧的下架不一致","severity":"P3","area":"frontend","status":"fixed","created":"2026-07-17"} -->
<a id="wb-190"></a>
...
<!-- issue-record:start {"id":"WB-191","number":191,"source":"WB-191-skillhub-mirror-no-delisting.md","title":"SkillHub 第三方市场缺少 Manager 集中下架策略","severity":"P3","area":"fullstack","status":"fixed","created":"2026-07-17"} -->
<a id="wb-191"></a>
...
<!-- issue-record:start {"id":"WB-192","number":192,"source":"WB-192-run-command-inherits-secrets.md","title":"run_command 子进程继承后端全部密钥（WB-011 只堵了连接器那条路）—— 模型一句 echo 就能读走 LLM_API_KEY","severity":"P1","area":"backend","status":"fixed","created":"2026-07-17"} -->
<a id="wb-192"></a>
...
<!-- issue-record:start {"id":"WB-193","number":193,"source":"WB-193-knowledge-add-url-and-mcp-verdict.md","title":"knowledge_add 只能加工作区文件，不能从 URL/文本入库 —— 承接 WB-175「留后续」；并记录「不接官方 WeKnora MCP server」的评估结论","severity":"P3","area":"backend","status":"fixed","created":"2026-07-17"} -->
<a id="wb-193"></a>
...
<!-- issue-record:start {"id":"WB-194","number":194,"source":"WB-194-connector-card-add-lost-on-navigate.md","title":"连接器卡「添加到本会话」是真状态但假用处 —— 用户一导航去用它就被 reset 清掉","severity":"P2","area":"frontend","status":"fixed","created":"2026-07-17"} -->
<a id="wb-194"></a>
...
<!-- issue-record:start {"id":"WB-195","number":195,"source":"WB-195-reco-category-chips-cannot-filter.md","title":"「推荐」段分类 chip 点了不过滤 —— SK_GRID 数据形状里根本没有分类字段","severity":"P3","area":"frontend","status":"fixed","created":"2026-07-17"} -->
<a id="wb-195"></a>
...
<!-- issue-record:start {"id":"WB-196","number":196,"source":"WB-196-expert-persona-fallback-fake.md","title":"专家人格也有兜底话术伪装 —— persona_for 对未知专家编一句「以「X」的专业身份作答」","severity":"P2","area":"backend","status":"fixed","created":"2026-07-17"} -->
<a id="wb-196"></a>
...
<!-- issue-record:start {"id":"WB-197","number":197,"source":"WB-197-app-url-routing-theme-audit.md","title":"应用内存态单页导航改为可直达多页路由，并审查明暗主题样式","severity":"P1","area":"frontend","status":"fixed","created":"2026-07-20"} -->
<a id="wb-197"></a>
...
<!-- issue-record:start {"id":"WB-198","number":198,"source":"WB-198-project-knowledge-base-config.md","title":"项目配置缺少知识库挂载与持久化，项目执行无法自动使用项目知识","severity":"P1","area":"fullstack","status":"fixed","created":"2026-07-20"} -->
<a id="wb-198"></a>
...
<!-- issue-record:start {"id":"WB-199","number":199,"source":"WB-199-system-settings-real.md","title":"系统设置仍是占位页，需要持久化并真实作用于应用","severity":"P1","area":"fullstack","status":"fixed","created":"2026-07-20"} -->
<a id="wb-199"></a>
