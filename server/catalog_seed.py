...
DEFAULT_TOOL_CATALOG: list[dict[str, Any]] = [
    ...
    {"name": "update_work_item_planning", "label": "更新工作项 Sprint", "description": "用真实 WorkItem/Sprint ID 和版本号更新当前项目的 Sprint 计划字段。", "category": "项目上下文", "risk_level": "medium", "exposure": "contextual", "bindable": False, "permissions": ["project.write"]},
