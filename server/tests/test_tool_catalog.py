...
class ToolCatalogTest(unittest.TestCase):
    ...
    def test_full_inventory_and_bindable_projection_are_separate(self) -> None:
        ...
        self.assertEqual(32, len(all_tools))
        ...
        self.assertEqual("automatic", all_by_name["start_work_item_run"]["exposure"])
        self.assertEqual(["project.write"], all_by_name["start_work_item_run"]["permissions"])
        self.assertFalse(all_by_name["start_work_item_run"]["bindable"])
        planning = all_by_name["update_work_item_planning"]
        self.assertEqual("contextual", planning["exposure"])
        self.assertEqual(["project.write"], planning["permissions"])
        self.assertFalse(planning["bindable"])
        ...
        self.assertEqual(32, len(pulled["tools"]))
