...
type Catalog = Pick<
  ...
  | 'INSP_CATS' | 'INSP' | 'INSP_TEMPLATES' | 'KB_TPLS'
>

const FALLBACK: Catalog = {
  QUICK: C.QUICK, PROJ_TPL: C.PROJ_TPL, EXP_SCENES: C.EXP_SCENES, EXP_CATS: C.EXP_CATS,
  EXP_GRID: C.EXP_GRID, EXP_TEAMS: C.EXP_TEAMS, EXPERT_RECOMMENDATIONS: C.EXPERT_RECOMMENDATIONS, SK_CATS: C.SK_CATS,
  SK_GRID: C.SK_GRID, CONNS: C.CONNS, CONN_META: C.CONN_META, AUTO: C.AUTO,
  SK_RECOMMENDATIONS: C.SK_RECOMMENDATIONS,
  CONNECTOR_RECOMMENDATIONS: C.CONNECTOR_RECOMMENDATIONS,
  ...
  INSP_CATS: C.INSP_CATS, INSP: C.INSP, INSP_TEMPLATES: C.INSP_TEMPLATES, KB_TPLS: C.KB_TPLS,
}
