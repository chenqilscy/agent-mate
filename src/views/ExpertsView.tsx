...
function CapabilityView({ kind }: { kind: CapabilityKind }) {
  ...
  const [skillBundlesOpen, setSkillBundlesOpen] = useState(false)
  ...
  return (
    <section className="view active" data-view={kind}>
      <div className="cap-top">
        ...
        {kind === 'skills' ? (
          <>
            <WbButton className="cap-act" onClick={() => setSkillBundlesOpen(true)}>
              技能组合
            </WbButton>
      ...
      <SkillBundleModal open={kind === 'skills' && skillBundlesOpen} onClose={() => setSkillBundlesOpen(false)} />
    </section>
  )
}
